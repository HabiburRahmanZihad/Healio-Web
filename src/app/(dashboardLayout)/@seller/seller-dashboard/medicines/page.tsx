    ...
    return (
        <div className="space-y-12 pb-20 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                <div className="space-y-3">
                    ...
                    <p className="text-xs md:text-sm text-muted-foreground font-medium max-w-xl">
                        Manage your verified pharmaceutical assets and monitor deployment stock levels across the <span className="text-white font-bold">Healio Nexus</span>.
                    </p>
                </div>
            ...
            {medicines.length === 0 && !isLoading && (
                <div className="p-12 md:p-32 rounded-[2rem] md:rounded-[3.5rem] bg-zinc-900/40 backdrop-blur-xl border-4 border-dashed border-white/5 flex flex-col items-center text-center gap-10">
                    <div className="relative">

...
export function MedicineDetailsClient({ medicine }: MedicineDetailsClientProps) {
    const { name, description, price, stock, image, manufacturer, category, requiresPrescription } = medicine;
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <button className="px-6 py-4 rounded-xl border border-white/20 text-white hover:bg-white/5 transition-colors">

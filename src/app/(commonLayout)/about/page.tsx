                    ...
                    <div className="container mx-auto max-w-5xl">
                        <div className="flex flex-col md:flex-row gap-16 items-center">
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-500 leading-relaxed font-medium">
                                    Founded in 2024, our journey began with a small group of technologists and pharmacists who believed that <span className="text-white">access to medicine should be as simple as a click</span>, without compromising on verification or safety.
                                </p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: 30 }}
                            ...
                            >
                                ...
                                <div className="w-full h-full rounded-3xl overflow-hidden border border-white/10 p-2 bg-white/5">
                                    <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl">
                                        <Image
                                            src="https://images.unsplash.com/photo-1576091160550-2173bdd9962a?q=80&w=2070&auto=format&fit=crop"
                                        ...
                                        <div className="absolute bottom-6 left-6 right-6">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-[8px] font-black tracking-widest uppercase">Est. 2024</span>
                                            </div>
